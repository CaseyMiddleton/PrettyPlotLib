...
def finalize_keep_frame(ax, fontsize=LABEL_SIZE, labelpad=7):
...
def lollipop_plot(ax, x, y, marker_col="k", marker_size=7.5, stem_col="lightgray"):
    markerline, stemlines, baseline = ax.stem(x, y, linefmt=stem_col, markerfmt="o")
   
    # circle markers
    markerline.set_color(marker_col)
